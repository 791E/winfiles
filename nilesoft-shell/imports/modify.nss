...
remove(find="Open in new tab|Open in new window|Share using Quick Share|Git GUI Here|Git Bash Here|Open with Code|Scan with Microsoft Defender...|Pin to Start|Cut|Copy|Delete|Rename")
